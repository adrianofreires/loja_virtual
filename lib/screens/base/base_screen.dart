...
class _BaseScreenState extends State<BaseScreen> {
  ...
  void initState() {
    ...
    configFirebaseCloudMessage();
  }

  void configFirebaseCloudMessage() {
    final firebaseCloudMessage = FirebaseMessaging();

    if (Platform.isIOS) {
      firebaseCloudMessage.requestNotificationPermissions(const IosNotificationSettings(provisional: true));
    }

    firebaseCloudMessage.configure(onLaunch: (Map<String, dynamic> message) async {
